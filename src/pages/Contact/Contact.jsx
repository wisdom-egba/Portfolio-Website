        ...
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div className="bg-[rgb(36,36,36)] px-4 py-3 sm:flex sm:flex-col sm:px-6">
              <a
                href="#"
                className="inline-flex w-full justify-center rounded-full border-[#F7AB0A] border  px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#F7AB0A] sm:ml-3 sm:w-auto"
              >
                Send Email
              </a>
